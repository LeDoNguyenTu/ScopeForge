...
This project is indexed by GitNexus as **ScopeForge** (18318 symbols, 30082 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
