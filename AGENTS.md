...
This project is indexed by GitNexus as **ScopeForge** (18283 symbols, 30033 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
