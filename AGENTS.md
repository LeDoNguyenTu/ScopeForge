...
This project is indexed by GitNexus as **ScopeForge** (18478 symbols, 30331 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
