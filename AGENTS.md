...
This project is indexed by GitNexus as **ScopeForge** (17924 symbols, 29352 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
