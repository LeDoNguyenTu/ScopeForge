        ...
        <div className="livingDashboardLower">
          <article className="livingOverviewPanel">
            ...
            <div className="livingOverviewContent">
              <div className="livingCoverageRing" aria-label={`${metrics.verificationPercent}% of registered assets are verified`}>
                <svg className="livingCoverageRingGraphic" viewBox="0 0 100 100" aria-hidden="true">
                  <circle className="livingCoverageRingTrack" cx="50" cy="50" r="46" pathLength="100" />
                  <circle
                    className="livingCoverageRingValue"
                    cx="50"
                    cy="50"
                    r="46"
                    pathLength="100"
                    strokeDasharray={`${metrics.verificationPercent} 100`}
                  />
                </svg>
