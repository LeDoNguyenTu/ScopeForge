...
export default function CommandCenterLandingHero() {
  return <section className="commandHero" aria-labelledby="command-hero-title">
    ...
    <div className="commandHeroCopy">
      ...
      <p className="commandHeroLead">Discover your attack surface, run authorized security testing through accepted runtimes, understand the evidence, and move from exposure to a verified fix. One connected view of your security work.</p>
