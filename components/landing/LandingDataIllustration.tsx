    ...
    <div className="commandMetricArea">
      ...
      <article className="commandOverviewPanel">
        ...
        <div className="commandOverviewBody">
          <div className="commandExposureGauge"><div className="commandExposureRing commandExposureRingSample" role="img" aria-label={`${metrics.verified} of ${metrics.assets} assets have verified ownership`}><svg className="commandExposureRingGraphic" viewBox="0 0 100 100" aria-hidden="true"><circle className="commandExposureRingTrack" cx="50" cy="50" r="46" pathLength="100"/><circle className="commandExposureRingValue" cx="50" cy="50" r="46" pathLength="100" strokeDasharray={`${metrics.coverage} 100`}/></svg><span>{metrics.verified}/{metrics.assets}</span></div><p>Ownership verified</p><em>{metrics.pending} awaiting proof</em></div>
