...
export default function Phase11CanaryForm({ assets }: { assets: readonly Phase11CanaryAsset[] }) {
  ...
  return (
    <form className="adminForm" action={action} aria-busy={pending}>
      <label>
        Verified target
        <select
          name="assetId"
          ...
          aria-describedby="phase11-canary-help phase11-canary-status"
        >
      ...
      <p className="adminMuted" id="phase11-canary-help">
