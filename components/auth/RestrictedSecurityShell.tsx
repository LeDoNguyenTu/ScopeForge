  ...
  return (
    <div className="restrictedSecurityShell">
      ...
      <main className="restrictedSecurityContent">
        <p className="restrictedSecurityNotice" role="status"><strong>Two-step verification is required for this workspace role.</strong> Finish authenticator enrollment before opening the workspace.</p>
        {children}
      </main>
    </div>
  );
