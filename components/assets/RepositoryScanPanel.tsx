      ...
      {managedByConnectedProject ? (
        <>
          <div className="verificationHeader">
            <div>
              <span className="sectionEyebrow">Scan provenance</span>
              <h2>Hosted scan history</h2>
              <p>Connected project scans publish reviewed zero-egress results here with immutable source and scanner provenance.</p>
            </div>
            <Cpu size={20} />
          </div>
