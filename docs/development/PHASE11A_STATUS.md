...
- Migration: `supabase/migrations/20260918070000_phase_11a_run_orchestration.sql`, source-only and unapplied.
...
Task 9 review found and fixed three important lifecycle/identity defects:
