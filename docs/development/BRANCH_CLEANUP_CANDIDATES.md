...
This file is the authoritative cleanup manifest until a real branch-delete surface is available. At reconciliation time the repository had 51 remote branches and only PR #74 was open.
...
- `feat/phase-10a-github-connected-projects` — active PR #74, frozen Phase 10A1 release candidate
- `feat/phase-10a2-private-repository-acquisition` — active stacked Phase 10A2 implementation
...
```text
main
feat/phase-10a-github-connected-projects
