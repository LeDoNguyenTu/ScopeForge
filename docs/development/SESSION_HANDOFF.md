...
Publish the active source branch and wait for exact-candidate CI. Keep migrations unapplied and the class disabled until worker authentication, idle claim/heartbeat, and class-scoped rollback are proven with the accepted immutable image.
