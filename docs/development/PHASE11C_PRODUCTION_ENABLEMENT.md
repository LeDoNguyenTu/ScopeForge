...
From production state, confirm the worker's `last_seen_at` advances while:
...
2. confirm only the Phase 11 worker stops heartbeating
...
6. confirm idle heartbeat resumes
